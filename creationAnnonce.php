<?php
	...
	if(isset($_POST['amis']) && isset ($_POST['description']) && isset($_POST['email']) && isset($_POST['siteweb']) && isset($_POST['telephone']) && isset($_POST['adresse']))
	{
		...
		if(!insertAnnonce($bdd,$login,$Amis,$description,$email,$siteweb,$telephone,$adresse))
		{
			...
			<section id="four" class="wrapper special">
				<div class="inner">
					<header class="major narrow">
						<h2>Ajoutez vos amis !</h2>
						<p>Remplissez ce formulaire ci-dessous pour aouter votre contact</p>
